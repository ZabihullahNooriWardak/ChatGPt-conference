...
const ArraySpeakers = [
  {
    path: 'images/OpenAI-Sam-Altman-h_15241239-final.webp', name: 'Sam Altman', job: 'Founder of ChatGPT', description: `  Sam Altman is an entrepreneur and computer scientist who has played
  ...
  {
    path: 'images/1_bmlZwr3rhfqMDGVnQR2BXA.jpg', name: 'Ilya Sutskever', job: 'Software Engineer at Open AI', description: `        is a Russian-born Israeli-Canadian computer scientist working in
  machine learning,[1] who co-founded and serves as Chief Scientist of
  OpenAI`,
  },
  {
    path: 'images/download.jpeg', name: 'Greg Brockman', job: 'AI developer', description: ` Greg Brockman is a computer scientist and the former CTO (Chief
  ...
  {
    path: 'images/fff.jpeg', name: 'Samy Bengio', job: 'Reasearcher at OpenAI', description: `  Samy Bengio is a research scientist at OpenAI and has contributed to the
  ...
  {
    path: 'images/EI0F2beM_400x400.jpeg', name: 'Alec Radford', job: 'Software Engineer', description: `Alec Radford is a research scientist and one of the original authors
    of the GPT model. He has made significant contributions to natural
    language processing and deep learning research.`,
  },
  {
    path: 'images/me_new.jpg', name: 'Karpathy', job: 'Researcher at OpenAI', description: `Andrej Karpathy is a research scientist and the Director of AI at
...
let containerSpeaker=document.querySelector('.container-speaker');
